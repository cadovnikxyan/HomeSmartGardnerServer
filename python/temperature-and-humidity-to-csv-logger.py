...
hist_temperature_file_path   = dir_path + "/sensor-values/temperature_" + sensor_name + "_log_" + str(date.today().year) + ".csv"
latest_temperature_file_path = dir_path + "/sensor-values/temperature_" + sensor_name + "_latest_value.csv"
hist_humidity_file_path      = dir_path + "/sensor-values/humidity_" + sensor_name + "_log_" + str(date.today().year) + ".csv"
latest_humidity_file_path    = dir_path + "/sensor-values/humidity_" + sensor_name + "_latest_value.csv"
